...
WebUI.setText(findTestObject('Object Repository/input_Visit Date (Required)_visit_date'), '12/12/2022')

WebUI.setText(findTestObject('Object Repository/textarea_Comment_comment'), 'Comment')
